...
const TYPE_ALIASES: Readonly<Record<string, FindingCategory>> = {
  ...
  // ── Web3 / Smart Contract / ZK Circuit ────────────────────────────────────
  REENTRANCY: "VULNERABILITY",
  REENTRANCYATTACK: "VULNERABILITY",
  INTEGEROVERFLOW: "VULNERABILITY",
  INTEGERUNDERFLOW: "VULNERABILITY",
  ARITHMETICOVERFLOW: "VULNERABILITY",
  TXORIGINAUTH: "VULNERABILITY",
  TXORIGINAUTHENTICATION: "VULNERABILITY",
  DELEGATECALL: "VULNERABILITY",
  DELEGATECALLSTORAGECOLLISION: "VULNERABILITY",
  FLASHLOAN: "VULNERABILITY",
  FLASHLOANATTACK: "VULNERABILITY",
  FRONTRUNNING: "VULNERABILITY",
  MEVATTACK: "VULNERABILITY",
  ORACLEMANIPULATION: "VULNERABILITY",
  UNCHECKEDARITHMETIC: "VULNERABILITY",
  CPIVULNERABILITY: "VULNERABILITY",
  CROSSPROGRAINVOCATION: "VULNERABILITY",
  UNDERCONSTRAINED: "VULNERABILITY",
  UNDERCONSTRAINEDSIGNAL: "VULNERABILITY",
  SOUNDNESSBUG: "VULNERABILITY",
  COMPLETENESSBUG: "VULNERABILITY",
  ZKWITNESSMISMATCH: "VULNERABILITY",
  MISSINGRANGECHECK: "VULNERABILITY",
  SMARTCONTRACTVULNERABILITY: "VULNERABILITY",
  SOLIDITYVULNERABILITY: "VULNERABILITY",
  SOROBANVULNERABILITY: "VULNERABILITY",
  ZKCIRCUITBUG: "VULNERABILITY",
